...
# Enable CORS mechanism in applicationlication
CORS(application)
...
application.jinja_env.filters["created_since"] = created_since
...
@application.route("/view/<int:note_id>")
@login_required
def view(note_id):
    """View a note"""
...
@application.route("/edit/<int:note_id>", methods=["GET", "POST"])
@login_required
def edit(note_id):
    """Edit a note"""
